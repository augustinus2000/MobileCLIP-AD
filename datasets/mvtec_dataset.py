"""
MVTec AD test dataset loader for dense anomaly localization.
...
class MVTecDenseDataset(Dataset):
    """
...
if __name__ == "__main__":
    ds = MVTecDenseDataset("../datasets/mvtec_anomaly_detection", image_size=256)
